  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.boxRow} >
          <TouchableOpacity style={styles.botao} onPress={this.onPressCientifica.bind(this, "Sin")} >
            <Text style={styles.text} >Sin</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.botao} onPress={this.onPressCientifica.bind(this, "Cos")} >
            <Text style={styles.text} >Cos</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.botao} onPress={this.onPressCientifica.bind(this, "Tan")} >
            <Text style={styles.text} >Tan</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.botao} onPress={this.onPressCientifica.bind(this, "Log")} >
            <Text style={styles.text} >Log</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.botao} onPress={this.onPressCientifica.bind(this, "Sqrt")} >
            <Text style={styles.text} >√</Text>
          </TouchableOpacity>
        </View>
